...
conn = psycopg2.connect(
    ...
    database="data_science",  # Byt ut med din databas
    user="postgres",  # Byt ut med ditt användarnamn
    password="postgres",  # Byt ut med ditt lösenord
    port="5432"
    )
cursor = conn.cursor()
...
csv_file_path = "data.visualization/sales_data.csv"  # Sökvägen till din CSV-fil
